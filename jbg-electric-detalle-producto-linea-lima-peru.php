          ...
          <section id="productos" class="">
            <div class="col s12 m4">
              <aside id="sidebarMenu">
                ...
                <!-- LISTA por marca -->
                <section id="sidebarScrollable" class="sidebarMenu hide">
                  <?php 
              ...
              <table width="" border="0" cellpadding="0" cellspacing="0" align="">
                ...
                ?>
                  <tr>
                    ...
                    <!-- Detalle -->
                    <td align="center" class="tdrow1">
                      <a href="jbg-electric-detalle-producto-lima-peru.php?idmarca=<?= $idmarca; ?>&idseccion=<?= $idseccion; ?>&nom_marca=<?= $nom_marca; ?>&seccion=<?= $seccion; ?>&subseccion=<?= $subseccion1; ?>&subnivel=<?= $subnivel; ?>&producto=<?= $producto['idproducto']; ?>#marca" class="vermas_productos"><img src="images/ver-detalle.png" width="90" height="29" /></a>
                    </td><!-- /center -->
                  </tr>
                <?php endforeach; ?>
              </table>
