...
<?php  
  ...
  $sublinea   = $_GET['seccion'];
  $subseccion = $_GET['idsubseccion'];
    ...
    <div class="container">
      ...
      <section class="bgPage--white">
        ...
        <div class="row">
          ...
          <!-- Titulo de la linea -->
          <h3><strong><?= $linea . " -> " . $sublinea ?></strong></h3>
          ...
          <section class="sectionPage__producto__content-marcas">
            ...
            ?>
              <ul class="dos_columnas">
                <li>
                  <a href="linea-productos-jbg-electric-lima-peru.php?idsubnivel=<?= $row['idseccion'] ?>&nom_marca=<?= $linea ?>&seccion=<?= $row['seccion'] ?>&subnivel=<?= $row['seccion'] ?>#lineas"><?= $row['seccion'] ?>
                  </a> <!-- /. -->
                </li> <!-- /li -->
              </ul> <!-- /dos_columnas -->
            <?php endforeach; ?>
