      ...
      <section class="bgPage--white">
        ...
        <div class="row">
          ...
          <section class="sectionPage__producto__content-marcas">
            <?php  
              $padre = empty($padre) ? 'IS NULL' : ' ' . $padre;
            ...
            ?>
              <ul class="dos_columnas">
                <li>
                  <a href="lista-subseccion-lineas-inovalec-electric-lima-peru.php?nom_marca='<?= $row['seccion']. "&subseccion=".$row['idseccion']."#lineas" ?>'"><?= $row['seccion'] ?>
                  </a> <!-- /. -->
                </li> <!-- /li -->
              </ul> <!-- /dos_columnas -->
            <?php endforeach; ?>
